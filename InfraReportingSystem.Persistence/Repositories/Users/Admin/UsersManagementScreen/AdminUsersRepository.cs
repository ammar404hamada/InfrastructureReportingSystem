...
namespace InfraReportingSystem.Persistence.Repositories.Users.Admin.UsersManagementScreen
{
    public class AdminUsersRepository : IAdminUsersRepository
    {
            ...
            int pageSize)
        {
            ...
            if (!string.IsNullOrWhiteSpace(roleFilter))
            {
                ...
                {
                    "Worker" => query.OfType<Domain.Entities.Worker>(),
                    "Authority" => query.OfType<Domain.Entities.Authority>(),
