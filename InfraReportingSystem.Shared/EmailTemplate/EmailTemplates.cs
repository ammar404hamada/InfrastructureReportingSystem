...
namespace InfrastructureReportingSystem.Shared.EmailTemplate
{
    ...
    public static class EmailTemplates
    {
        ...
        /// <summary>
        /// Generates an account-created notification email template with the user's login credentials.
        /// </summary>
        /// <param name="UserName">The recipient's display name</param>
        /// <param name="UserEmail">The recipient's email address</param>
        /// <param name="Password">The generated password for first login</param>
        /// <param name="LoginLink">The frontend login URL</param>
        /// <returns>A formatted HTML email string ready to be sent via SMTP</returns>
        public static string AccountCreatedWithPasswordTemplate(string UserName, string UserEmail, string Password, string LoginLink)
        {
            string template = $"""
                <!DOCTYPE html>
                <html lang="en">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0"
                          ...
                          <tr>
                            <td style="padding:36px 44px; color:#ffffff;">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                  <td style="padding:12px 24px 4px 24px;">
                                    <p style="margin:0; color:#9c9c9c; font-size:13px;">
                                      Email
                                    </p>
                                    <p style="margin:4px 0 0 0; color:#ffffff; font-size:15px;">
                                      {UserEmail}
                                    </p>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  <td style="padding:12px 24px 20px 24px;">
                                    ...
                                    <div style="margin:4px 0 0 0; color:#ff9800; font-size:18px; font-family:Consolas, monospace; word-break:break-all;">
                                      {Password}
                                    </div>
                                  </td>
                                </tr>
                              ...
                              <!-- Login Link -->
                              <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="margin-top:24px; background-color:#1a1a1a; border:1px solid #3a3a3a; border-radius:12px; border-collapse:separate;">

                                <tr>
                                  <td align="center" style="padding:20px 24px;">
                                    <p style="margin:0 0 12px 0; color:#9c9c9c; font-size:11px; letter-spacing:4px;">
                                      LOGIN TO YOUR ACCOUNT
                                    </p>
                                    <a href="{LoginLink}"
                                      style="color:#ff9800; font-size:16px; text-decoration:underline;">
                                      {LoginLink}
                                    </a>
                                  </td>
                                </tr>
        ...
        /// <summary>
        /// Generates an email template notifying a worker that a public user has confirmed or rejected their fix.
        /// </summary>
        /// <param name="WorkerName">The worker's display name</param>
        /// <param name="WorkerEmail">The worker's email address, displayed in the footer</param>
        /// <param name="ReportId">The report ID number</param>
        /// <param name="Description">The report description text</param>
        /// <param name="CategoryName">The category name of the report</param>
        /// <param name="StatusLabel">"Resolved" or "Fix Rejected"</param>
        /// <param name="Message">The status message (e.g., "confirmed" or "rejected")</param>
        /// <param name="Reason">The reason for rejection (null if confirmed)</param>
        /// <param name="Timestamp">Formatted date/time string of the action</param>
        /// <returns>A formatted HTML email string ready to be sent via SMTP</returns>
        public static string FixConfirmationEmailTemplate(
            string WorkerName, string WorkerEmail, string ReportId,
            string Description, string CategoryName,
            string StatusLabel, string Message, string? Reason, string Timestamp)
        {
            string template = $"""
                <!DOCTYPE html>
                <html lang="en">
                          ...
                          <tr>
                            <td align="center"
                              ...
                              <p style="margin:0; color:#6a6a6a; font-size:12px; line-height:1.8;">
                                © 2026 Infrastructure Reporting System — EELU Graduation Project
                                <br />
                                This email was sent to {WorkerEmail}
                              </p>
