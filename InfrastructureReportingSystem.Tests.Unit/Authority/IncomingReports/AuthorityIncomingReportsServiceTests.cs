...
using InfraReportingSystem.Shared.DTOs.Authority.IncomingReports;
using Microsoft.Extensions.Logging;
using Moq;
using Xunit;

namespace InfrastructureReportingSystem.Tests.Unit.Authority.IncomingReports
{
    public class AuthorityIncomingReportsServiceTests
    {
        ...
        [InlineData("This description is longer than eighty characters to check if ellipsis is appended correctly in the mapped title.","This description is longer than eighty characters to check if ellipsis is append…")]        [InlineData(null, "")]
        [InlineData("", "")]
